...
Evaluations are a core feature of the ServeQuery library. It offers both a catalog of 100+ evals and a framework to easily configure yours. Before exploring, make sure know the core workflow: try an example for [LLMs](docs/quickstart_llm) or [ML](docs/quickstart_ml).
