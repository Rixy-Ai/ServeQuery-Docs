---
title: "Telemetry"
description: "What data is collected when you use ServeQuery open-source."
---

Telemetry refers to the collection of usage data. We collect some data to understand how many users we have and how they interact with ServeQuery open-source.
...
Telemetry is collected in ServeQuery starting from **version 0.4.0**.

We only collect telemetry when you use **ServeQuery Monitoring UI**. We DO NOT collect any telemetry when you use the tool as a library, for instance, run in a Jupyter notebook or in a Python script to generate ServeQuery Reports.
...
**Environment data**. Basic information about the environment in which you run ServeQuery:
...
* What is the environment you run ServeQuery in?
