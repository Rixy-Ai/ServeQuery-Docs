...
ServeQuery Cloud lets you automate adversarial test generation based on defined categories of risk.
...
In the ServeQuery UI, start a new Project or open an existing one.
...
<Info>
  **Dataset API.** How to work with [ServeQuery datasets](/docs/platform/datasets_overview).
</Info>