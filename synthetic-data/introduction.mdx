...
<Check>
  This feature is available in ServeQuery Cloud. Check [pricing](https://www.servequery.com/pricing) details. [Reach out](https://www.servequery.com/get-demo) if you’d like a demo.
</Check>

ServeQuery Cloud lets you generate synthetic test inputs (and outputs) to evaluate your AI system. You can use it for:
...
Once you generate the data, you can run it through your AI system and evaluate the results using the ServeQuery Cloud or ServeQuery Python library as usual.
