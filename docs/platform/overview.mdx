---
title: 'Introduction'
description: 'ServeQuery Platform at a glance.'
---

ServeQuery Platform helps you manage AI quality across the AI system lifecycle, from pre-deployment testing to production monitoring. It supports evaluations of open-ended LLM outputs, predictive tasks like classification, and complex workflows like AI agents.
...
<Info>
  ServeQuery Platform has a lightweight open-source version for evaluation tracking and monitoring, and a Cloud/Enterprise version with extra features. [Check feature availability.](/faq/oss_vs_cloud)
</Info>

<Tabs>
  <Tab title="Evaluations">
    Run evaluations locally with the ServeQuery Python library or no-code on the platform. Use 100+ built-in evals and templates. Track, compare, and debug experiments.
