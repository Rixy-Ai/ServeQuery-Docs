...
| --------------- | ---------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- |
| `address`       | Trace collector address. Defaults to `https://app.servequery.cloud/`.                                                               | `SERVEQUERY_TRACE_COLLECTOR`             |
| `api_key`       | ServeQuery Cloud API key.                                                                                                           | `SERVEQUERY_TRACE_COLLECTOR_API_KEY` or `SERVEQUERY_API_KEY`    |
| `export_name`   | Tracing dataset name. Traces with the same name are grouped into a single dataset.                                                 | `SERVEQUERY_TRACE_COLLECTOR_EXPORT_NAME` |
| `project_id`    | Destination Project ID in ServeQuery Cloud.                                                                                         | `SERVEQUERY_TRACE_COLLECTOR_PROJECT_ID`  |
