...
<Check>
  Synthetic data generation is an add-on available on some ServeQuery Cloud and Enterprise plans. Check details on the [pricing](https://www.servequery.com/pricing) page. [Request a demo](https://www.servequery.com/get-demo) or contact sales@servequery.com for extended trial access. You can also apply for a [startup discount](https://www.servequery.com/sign-up-startups).
</Check>
