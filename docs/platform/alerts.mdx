...
<Check>
  Built-in alerting is a Pro feature available in the **ServeQuery Cloud** and **ServeQuery Enterprise**.
</Check>
...
If you use Tests (conditional checks) in your Project, you can tie alerting to the failed Tests in a Test Suite. Toggle this option on the Alerts page. ServeQuery will set an alert to the defined channel if any of the Tests fail.
