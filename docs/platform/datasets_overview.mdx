...
<Check>
  Datasets are available in **ServeQuery Cloud** and **ServeQuery Enterprise**.
</Check>
...
* **Create from Traces**. During tracing, ServeQuery automatically generates tabular datasets that can be used for evaluations.
...
You can synthesize evaluation datasets directly in ServeQuery Platform:
...
Here are common use cases for datasets in ServeQuery:
