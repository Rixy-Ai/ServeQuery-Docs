...
<Check>
  Trace store and viewer are Pro features available in **ServeQuery Cloud** and **ServeQuery Enterprise**.
</Check>
...
ServeQuery provides multiple ways to explore tracing data.
...
Tracing is optional on the ServeQuery Platform. You can also:
