...
This relies on the core evaluation API of the ServeQuery Python library. Check the [detailed guide](/docs/library/evaluations_overview).
...
<Steps>
  <Step title="Run a Report">
    Configure the evals and run the [ServeQuery Report](/docs/library/report) with optional [Test ](/docs/library/tests)conditions.
  </Step>
...
<Check>
  Raw data upload is available only for ServeQuery Cloud and Enterprise.
</Check>
