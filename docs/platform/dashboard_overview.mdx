...
<Check>
  Dashboard is available in **ServeQuery OSS**, **ServeQuery Cloud** and **ServeQuery Enterprise**.
</Check>
...
<Check>
  Multiple Tabs are available in **ServeQuery Cloud** and **ServeQuery Enterprise**.
</Check>
...
When adding a Panel, you select a **Metric**, and ServeQuery pulls the corresponding value(s) from all Reports in the Project to plot them.
